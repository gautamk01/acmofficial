...
function Footer() {
  return (
<<<<<<< HEAD
    <div className="p-20 bg-gradient-to-l addedbg1 ">
      <footer>
        <div class="grid grid-cols-4 gap-4">
          ...
          <div>
            ...
            <p>ACM Student Chapter, Amritapuri, Kollam, Kerala - 690546</p>
...
<ul className="list-none mb-0">
  <li>
    <a href="#!" className="text-gray-800">About ACM</a>
  </li>
  <li>
    <a href="#!" className="text-gray-800">Join ACM</a>
  </li>
  <li>
    <a href="#!" className="text-gray-800">Amrita Vishwa Vidyapeetham ASE,Amritapuri</a>
  </li>
</ul>
                </div>
                <div>
...
>>>>>>> 2af5119 (Made 'Our Objective' section responsive)
    </div>
  );
}
