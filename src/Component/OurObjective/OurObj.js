...
function OurObj() {
  return (
    <div
      className="h-[100vh] w-[100%] grid grid-cols-1 md:grid-cols-2 gap-2 content-center justify-items-center font-poppins addedbg2 "
      id="our-objective"
    >
      <img
        src={require("../../assets/amrita-logo.png")}
        alt="ourobj"
        className="hidden md:block h-[25rem] w-[25rem]"
      ></img>
      ...
      <div className="p-12">
        ...
        <p className="font-normal text-lg text-slate-400">
          The objective of the chapter to promote computer science as a field of
          education and foster a sense of innovation and creativity among
