...
function About() {
  return (
    <div className="h-[100vh] w-[100%] gridStyle bg-gradient-to-r addedbg1 font-poppins">
    ...
    return ( 
        <div id="AboutUs" className="h-[100vh] w-[100%] gridStyle bg-gradient-to-r from-white to-cyan-200 font-poppins">
            <div id="details-AboutUs" className="flex-col pl-2 w-[80%] About space-y-5">
                ...
                <h1 className="text-6xl font-bold">About Our Chapter</h1>
                <p className="text-slate-400">
                    Amrita ACM Student Chapter in Amritapuri is 
                    striving to conduct varied events for the 
                    student community of our university 
                    to enhance the coding skills, creative skills
                    and other required skills needed for their 
                    employment and growth. Encouraging students to 
                    take an active interest in the emerging and 
                    exciting world of computing preparations and 
                    presentations of the technical reports and papers,and 
                    cooperative efforts on research projects allow 
                    students to test their technical expertise.
                </p>
                <button className="p-3 bg-sky-400 rounded-md text-white text-sm transition ease-in-out hover:scale-105 hover:shadow-md">Get in Touch</button>
            </div>
            <Carousel className="Carousel"/>
        </div>
     );
>>>>>>> 510940b570ddd173568cd13c2a74941ca57f07b7
}
